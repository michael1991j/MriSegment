...
int main(int argc, char **argv) {
	...
	QDir directory(
			  QString::fromAscii(config->GetSettings("Imagesets","tdcubefat","/home/mri/Dropbox/School/MRI Segmentation/SampleData/SaikatKnee2012/002-SagittalCube-NoFatSat/")));
	...
	QDir dir(
			QString::fromAscii(config->GetSettings("Imagesets","tdcubewater","/home/mri/Dropbox/School/MRI Segmentation/SampleData/SaikatKnee2012/002-SagittalCube-NoFatSat/")));
